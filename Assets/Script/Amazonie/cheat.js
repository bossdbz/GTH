...
var obj: GameObject = GameObject.Find("First Person Controller");
	...
	var obj14: GameObject = GameObject.Find("sol-1");
	var obj15: GameObject = GameObject.Find("prompteur-a");
	//Sphere12
	...
	if(( i > 55) && (i < 60))
		obj.transform.transform.position= Vector3(obj9.transform.position.x + 1,obj9.transform.position.y+0.5, obj9.transform.position.z);
	if(( i > 65) && (i < 70))
	...
	if(( i > 110) && (i < 120))
		obj.transform.transform.position= Vector3(obj14.transform.position.x,obj14.transform.position.y, obj14.transform.position.z+40);
	if(( i > 120) && (i < 130))
		obj.transform.transform.position= Vector3(obj15.transform.position.x,obj15.transform.position.y, obj15.transform.position.z-65);
